...
<script runat="server">
    ...
    Protected Sub Button4_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        sMessage = "本題計算" & A.Text & "+" & B.Text & "=" & T3.Text & vbNewLine & "測試'單引號' "
        MsgBox(D.Text & vbNewLine & sMessage)
        '原始是MsgBox(sMessage)，後來改成文字框內置D，文字框內值是文字，利用&隔開資料，宣告斷行
        'T1.Text = CInt(T1 & "-" & T1) '點下按鈕 T1.Text = CInt(0)
        T1.Text = ""
        T2.Text = ""
        T3.Text = ""
        A.Text = "等待出題"
